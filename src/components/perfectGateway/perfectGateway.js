  ...
  return (
    <div className='perfectGateway-container'>
      ...
      <div className='perfectGateway-content'>
        ...
        {/* Text Card: Easy Access */}
        <div className='perfectGateway-easy-access'>
          <div className='perfectGateway-easy-accessInner'>
          <h2>Easy Access, Stunning Views</h2>
          <p>
            Easy access to visit stunning Jalori Pass, located in Kullu District
            at a distance of about 520 kilometers from Delhi, 150 kilometers
            from Shimla, and 60 kilometers from Mandi.
          </p>
        </div>
        </div>

        {/* Image Card: Tasty Foods */}
        ...
        {/* Text Card: Culinary Delights */}
        <div className='perfectGateway-card-type4'>
          <div className='perfectGateway-card-type4-inner'>
          <h2>Culinary Delights</h2>
          <p>
            Indulge your senses with a culinary journey that celebrates local
            flavors and fresh ingredients. Our menu boasts a diverse range of
            dishes, from traditional favorites to innovative creations.
          </p>
          </div>
        </div>
      </div>
