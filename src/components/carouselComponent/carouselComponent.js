...
const carouselData = [
  {
    ...
    description: 'Relax by the scenic riverfront. Perfect for romantic evenings and peaceful retreats.',
  },
  {
    id: 2,
    image: Hotel2,
    title: 'Saavi Hotel Medicity',
    description: 'Enjoy the serene beach view from our premium suites. Perfect for a relaxing getaway.',
  },
  {
    id: 3,
    image: Hotel3,
    title: 'Saavi Hotel Gold Course',
    description: 'Stay amidst the tranquil mountains. Ideal for nature lovers and hikers. Breathe fresh air and rejuvenate your soul.',
  },
  {
    id: 4,
    image: Hotel8,
  ...
  },
  {
    ...
    description: 'Admire the breathtaking sky views from your room. Ideal for stargazers and dreamers.',
  },
  {
    id: 7,
    image: Hotel7,
    title: 'Saavi Hotel Huda City Centre',
    description: 'Escape to the peaceful countryside. Enjoy farm-to-table dining and serene landscapes. Great for family vacations.',
  },
  {
    id: 8,
    image: Hotel4,
