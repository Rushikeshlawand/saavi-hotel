...
import SecondImage1 from '../../assets/bookNow/SeconeImage.png'
import SecondImage2 from '../../assets/bookNow/secondImage1.png'
    ...
    <div className='forEmptyspace'>
      <div className='background'>
        ...
        {showSalmanImages ? (
          <>
            {/* Salman images */}
            <img src={SecondImage1} alt='Salman 1' className='boy-image' />
            <img src={SecondImage2} alt='Salman 2' className='girl-image' />
          </>
        ) : (
          <>
            {/* Boy and Girl images */}
